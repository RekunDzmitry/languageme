...
//
// Consumed by the AI-graded email composer (/email route + Training "Email" tab),
// which reads sections of type 'email_writing'. The phrase/formula drills and the
// structure grammar live separately in theme22 (E-mail: структура и фразы).
...
const theme19EmailWriting = {
  ...
  descriptionRu: 'Тренируем написание e-mail в формате экзамена TELC (B1/B2). В каждом задании 3 обязательных пункта.',
