...
const theme01 = {
  ...
  verbList: [
    ...
    { infinitive: 'relever', ru: 'подхватывать, принимать', group: 'e→è: основа' },
    { infinitive: 'élever', ru: 'воспитывать, растить', group: 'e→è: основа' },
...
const theme02 = {
  ...
  verbList: [
    ...
    { infinitive: 'relever', ru: 'не подхватывать, не принимать', group: 'e→è: основа' },
    { infinitive: 'élever', ru: 'не воспитывать, не растить', group: 'e→è: основа' },
