        ...
        <div className="animate-fade-in">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl font-bold text-green-400 border border-green-400/40 hover:bg-green-400/10 transition-colors"
            >
              {t('exercise_correct')}
            </button>
            <button
              onClick={() => onAnswer(false)}
              className="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl font-bold text-red-400 border border-red-400/40 hover:bg-red-400/10 transition-colors"
            >
