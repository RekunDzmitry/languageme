...
--   fr_314 (relever)  "отмечать, фиксировать"     (was "поднимать, отмечать")
...
UPDATE vocab_translation
   SET text = 'отмечать, фиксировать'
 WHERE vocab_id = 'fr_314'
   AND lang = 'ru'
   AND text = 'поднимать, отмечать';
...
UPDATE vocab_translation
   SET text = 'to note / to record'
 WHERE vocab_id = 'fr_314'
   AND lang = 'en'
   AND text = 'to raise / to note';
...
UPDATE theme_verb
   SET ru = 'отмечать, фиксировать'
 WHERE theme_id = 'fr_theme01'
   AND infinitive = 'relever'
   AND ru = 'поднимать, отмечать';
